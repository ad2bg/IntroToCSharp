...
{
    /// <summary>
    /// Permutations defines a meta-collection,
    /// </summary>
    /// <remarks>
    /// typically a list of lists, of all possible orderings of a set of values.
    /// This list is enumerable and allows the scanning of all possible
    /// permutations using a simple foreach() loop.
    /// The MetaCollectionType parameter of the constructor allows for the
    /// creation of two types of sets, those with and without repetition
    /// in the output set when presented with repetition in the input set.
    ...
    /// {A A B}, {A B A}, {B A A}
    ///
    /// When generating non-repetition sets,
    /// ordering is based on the lexicographic ordering of the lists
    /// based on the provided Comparer.
    /// If no comparer is provided, then T must be IComparable on T.
    ///
    /// When generating repetition sets,
    /// no comparisons are performed and therefore
    ...
    public class Permutations<T> : IMetaCollection<T>
    {
        ...
        /// </summary>
        /// <remarks>
        /// must at least provided a list of values.
        /// </remarks>
        ...
        /// If T does not implement IComparable
        /// use a constructor with an explicit IComparer.
        /// The repetition type defaults to
        /// MetaCollectionType.WithholdRepetitionSets
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// If type is MetaCollectionType.WithholdRepetitionSets,
        /// then values (T) must implement IComparable.
        /// If T does not implement IComparable
        /// use a constructor with an explicit IComparer.
        /// </remarks>
        /// <param name="values">List of values to permute.</param>
        ...
        /// <param name="values">List of values to permute.</param>
        /// <param name="comparer">
        /// Comparer used for defining the lexicographic order.</param>
        ...
        /// <summary>
        /// Gets an enumerator for collecting a list of permutations.
        /// </summary>
        ...
        /// <summary>
        /// The enumerator that enumerates each meta-collection
        /// </summary>
        /// <remarks>
        /// of the enclosing Permutations class.
        /// </remarks>
        public class Enumerator : IEnumerator<IList<T>>
        {
            ...
            {
                myParent = source;
                myLexicographicalOrders =
                    new int[source.myLexicographicOrders.Length];
            ...
            /// <summary>
            /// Resets the permutations enumerator
            /// </summary>
            /// <remarks>
            /// to the first permutation.
            /// This will be the first lexicographically order permutation.
            /// </remarks>
            public void Reset() { myPosition = Position.BeforeFirst; }

            /// <summary>
            /// Advances to the next permutation.
            /// </summary>
            /// <returns>
            /// True if successfully moved to next permutation,
            /// False if no more permutations exist.
            /// </returns>
            /// <remarks>
            /// Continuation was tried (i.e. yield return)
            /// but was not nearly as efficient.
            /// Performance is further increased by using value types and
            /// removing generics, that is,
            /// the LexicographicOrder parallel array.
            /// This is a issue with the .NET CLR not optimizing
            /// as well as it could in this infrequently used scenario.
            /// </remarks>
            ...
            /// <summary>
            /// Cleans up non-managed resources,
            /// </summary>
            /// <remarks>
            /// of which there are none used here.
            /// </remarks>
            ...
            /// </summary>
            /// <remarks>
            /// This is a permutation with repetition where values that compare
            /// as equal will not swap positions to create a new permutation.
            /// http://www.cut-the-knot.org/do_you_know/AllPerm.shtml
            /// E. W. Dijkstra, A Discipline of Programming, Prentice-Hall, 1997
            /// </remarks>
            /// <returns>True if a new permutation has been returned,
            /// false if not.</returns>
            /// <remarks>
            /// This uses the integers of the lexicographical order
            /// of the values so that any comparison of values
            /// are only performed during initialization.
            /// </remarks>
            private bool NextPermutation()
            {
                int i = myLexicographicalOrders.Length - 1;
                while
                    (myLexicographicalOrders[i - 1] >=
                    myLexicographicalOrders[i])
                {
                    --i;
                    if (i == 0) { return false; }
                }
            ...
            /// </summary>
            /// <remarks>
            /// within the internal collection.
            /// This swaps both the lexicographical order and the values,
            /// maintaining the parallel array.
            /// </remarks>
            ...
            /// <summary>
            /// Single instance of swap variable for T,
            /// </summary>
            /// <remarks>
            /// small performance improvement
            /// over declaring in Swap function scope.
            /// </remarks>
            private T myTemp;

            /// <summary>
            /// Single instance of swap variable for int,
            /// </summary>
            /// <remarks>
            /// small performance improvement
            /// over declaring in Swap function scope.
            ...
            /// <remarks>
            /// that represent
            /// the location of items in the myValues array.
            /// This is generated at Initialization
            /// and is used as a performance speed up
            /// rather than comparing T each time,
            /// much faster to let the CLR optimize around integers.
            /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// If type is MetaCollectionType.WithholdGeneratedSets,
        /// then this does not double count permutations
        /// with multiple identical values.
        /// I.e. count of permutations of "AAB" will be 3 instead of 6.
        /// If type is MetaCollectionType.WithRepetition,
        /// then this is all combinations and is therefore N!,
        ...
        /// </summary>
        /// <remarks>
        /// equal to the number of items in the initial set.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// equal to the number of items returned each iteration.
        ...
        /// <summary>
        /// Common initializer used by the multiple constructors.
        /// </summary>
        /// <remarks>
        /// Copies information provided and then creates a parallel int array
        /// of lexicographic orders that will be used
        /// for the actual permutation algorithm.
        /// The input array is first sorted as required for WithoutRepetition
        /// and always just for consistency.
        /// This array is constructed one of two way
        /// depending on the type of the collection.
        ///
        /// When type is MetaCollectionType.WithRepetition,
        /// then all N! permutations are returned
        /// and the lexicographic orders are simply generated as
        /// 1, 2, ... N.
        /// E.g.
        /// Input array:          {A A B C D E E}
        /// Lexicographic Orders: {1 2 3 4 5 6 7}
        ///
        /// When type is MetaCollectionType.WithoutRepetition,
        /// then fewer are generated, with each
        /// identical element in the input array not repeated.
        /// The lexicographic sort algorithm
        ...
        private void Initialize(
            IList<T> values, GenerateOption type, IComparer<T> comparer)
        {
        ...
        /// <summary>
        /// Calculates the total number of permutations
        /// </summary>
        /// <remarks>
        /// that will be returned.
        /// As this can grow very large,
        /// extra effort is taken to avoid overflowing the accumulator.
        /// While the algorithm looks complex,
        /// it really is just collecting numerator and denominator terms
        /// and cancelling out all of the denominator terms
        /// before taking the product of the numerator terms.
        /// </remarks>
        ...
        /// <includes>
        /// myValues
        /// myLexicographicOrders
        /// SelfComparer
        /// myCount
        /// myMetaCollectionType
        /// </includes>
        #region Data and Internal Members

        /// <summary>
        /// A list of T that represents the order of elements
        /// </summary>
        /// <remarks>
        /// as originally provided, used for Reset.
        /// </remarks>
        private List<T> myValues;
        ...
        /// </summary>
        /// <remarks>
        /// that represent the location of items in the myValues array.
        /// This is generated at Initialization and is used
        /// as a performance speed up rather that comparing T each time,
        /// much faster to let the CLR optimize around integers.
        /// </remarks>
        private int[] myLexicographicOrders;

        /// <summary>
        /// Inner class that wraps an IComparer
        /// </summary>
        /// <remarks>
        /// around a type T when it is IComparable
        /// </remarks>
        private class SelfComparer<U> : IComparer<U>
        {
            public int Compare(U x, U y) =>
                ((IComparable<U>)x).CompareTo(y);
        }
        ...
        /// </summary>
        /// <remarks>
        /// Calculated at Initialization and returned by Count property.
        /// </remarks>
