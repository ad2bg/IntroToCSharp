...
namespace LoginForm {
    ...
    public partial class databaseDataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public usersRow AddusersRow(uint user_id, string login, string password, string first_name, string last_name, string gender) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public usersRow FindByuser_id(uint user_id) {
        ...
        public partial class usersRow : global::System.Data.DataRow {
            ...
            public uint user_id {
                get {
                    return ((uint)(this[this.tableusers.user_idColumn]));
                }
                set {
...
namespace LoginForm.databaseDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `users` WHERE ((`user_id` = @p1) AND (`login` = @p2) AND (`password` " +
                "= @p3) AND (`first_name` = @p4) AND (`last_name` = @p5) AND (`gender` = @p6))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `users` (`login`, `password`, `first_name`, `last_name`, `gender`) VA" +
                "LUES (@p1, @p2, @p3, @p4, @p5)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `users` SET `login` = @p1, `password` = @p2, `first_name` = @p3, `last_nam" +
                "e` = @p4, `gender` = @p5 WHERE ((`user_id` = @p6) AND (`login` = @p7) AND (`pass" +
                "word` = @p8) AND (`first_name` = @p9) AND (`last_name` = @p10) AND (`gender` = @" +
                "p11))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `user_id`, `login`, `password`, `first_name`, `last_name`, `gender` FROM `" +
                "users`";
